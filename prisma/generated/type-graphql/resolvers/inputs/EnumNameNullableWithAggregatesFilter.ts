...
import { NestedEnumNameNullableWithAggregatesFilter } from "../inputs/NestedEnumNameNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { Name } from "../../enums/Name";

@TypeGraphQL.InputType("EnumNameNullableWithAggregatesFilter", {
  isAbstract: true
})
export class EnumNameNullableWithAggregatesFilter {
